...
public static partial class ServiceBusHandlerFunctionSourceGeneratorTest
{
    private static readonly IReadOnlyList<MetadataReference> MetadataReferences
        ...
        [
            ...
            CreateFromType<ServiceBusFunctionAttribute>(),
    ...
    private static GeneratorDriverRunResult RunGenerator(string sourceCode)
    {
        var compilation = CSharpCompilation.Create(
            assemblyName: "Azure.ServiceBus.Generator.DynamicTests",
            syntaxTrees:
            [
    ...
    {
        var assembly = Assembly.Load("GarageGroup.Infra.Azure.ServiceBus.Generator");
        var generatorType = assembly.GetType("GarageGroup.Infra.ServiceBusHandlerFunctionSourceGenerator", throwOnError: true)!;
