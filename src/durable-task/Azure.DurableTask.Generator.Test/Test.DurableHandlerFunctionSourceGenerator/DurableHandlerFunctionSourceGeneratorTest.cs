...
public static partial class DurableHandlerFunctionSourceGeneratorTest
{
    private static readonly IReadOnlyList<MetadataReference> MetadataReferences
        ...
        [
            ...
            CreateFromType<ActivityFunctionAttribute>(),
    ...
    private static GeneratorDriverRunResult RunGenerator(string sourceCode)
    {
        var compilation = CSharpCompilation.Create(
            assemblyName: "Azure.DurableTask.Generator.DynamicTests",
            syntaxTrees:
            [
    ...
    {
        var assembly = Assembly.Load("GarageGroup.Infra.Azure.DurableTask.Generator");
        var generatorType = assembly.GetType("GarageGroup.Infra.DurableHandlerFunctionSourceGenerator", throwOnError: true)!;
